...
public class VideoCompress {
    ...
    public static boolean videoCompress(String filePath, String outputPath, VideoController.CompressProgressListener compressProgressListener) {

        return VideoController
                .getInstance()
                .convertVideo(filePath, outputPath,
                        VideoController.COMPRESS_QUALITY_HIGH, compressProgressListener);

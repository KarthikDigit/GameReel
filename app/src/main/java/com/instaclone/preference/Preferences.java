package com.instaclone.preference;
...
public enum Preferences {
    ...
    private static final String API_ACCESS_TOKEN = "api_access_token_type";
    ...
    private static final String API_ACCESS_EMP_CODE = "emp_code";
    private static final String API_ACCESS_UNIT = "unit";
    ...
    public void putLanguage(String language) {
        ...
        mPreferenceHandle.setString(KEY_CHOOSE_LANGUAGE, language);

    }

    public String getLanguage() {

        return mPreferenceHandle.getString(KEY_CHOOSE_LANGUAGE, "English");
    ...
    public void putApiAccessToken(String token) {

        mPreferenceHandle.setString(API_ACCESS_TOKEN, token);
    }

    public String getApiAccessToken() {

        return mPreferenceHandle.getString(API_ACCESS_TOKEN, null);
    }

    public void putEmpCode(String emp_code) {

        mPreferenceHandle.setString(API_ACCESS_EMP_CODE, emp_code);

    }

    public void putUnit(String unit) {

        mPreferenceHandle.setString(API_ACCESS_UNIT, unit);

    }

    public String getEmpCode() {

        return mPreferenceHandle.getString(API_ACCESS_EMP_CODE, "");
    }

    public String getUnit() {

        return mPreferenceHandle.getString(API_ACCESS_UNIT, "");
    }

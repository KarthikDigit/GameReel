...
public class HomeViewFeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements CacheManager {

    private Context mContext;
    private List<MyFeeds.Feed> myFeedsList;

    public HomeViewFeedAdapter(Context mContext, List<MyFeeds.Feed> myFeedsList) {

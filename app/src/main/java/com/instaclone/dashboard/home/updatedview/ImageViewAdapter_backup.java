...
public class ImageViewAdapter_backup extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<MyFeeds.Feed.Image> imageList;

    public ImageViewAdapter_backup(List<MyFeeds.Feed.Image> imageList) {
        this.imageList = imageList;
    }

    public void update(List<MyFeeds.Feed.Image> imageList) {
    ...
    public int getItemViewType(int position) {
        return imageList.get(position).postType;
    }
    ...
    static class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(MyFeeds.Feed.Image image) {
...
//            }
        ...
        void bind(@NonNull RecyclerView.Adapter adapter, MyFeeds.Feed.Image image, List<Object> payloads) {

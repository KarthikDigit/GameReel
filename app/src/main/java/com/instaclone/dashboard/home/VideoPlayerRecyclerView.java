...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    // vars
    private List<MyFeeds.Feed> mediaObjects = new ArrayList<>();
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        MyFeeds.Feed feed = mediaObjects.get(targetPosition);

        MyFeeds.Feed.Image image = feed.images.get(0);

        if (image.media.endsWith(".mp4")) {

            String mediaUrl = image.media;
            if (mediaUrl != null) {
    ...
    public void setMediaObjects(List<MyFeeds.Feed> mediaObjects) {

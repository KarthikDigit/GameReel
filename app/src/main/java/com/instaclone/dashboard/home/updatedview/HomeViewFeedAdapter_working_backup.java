...
public class HomeViewFeedAdapter_working_backup extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements CacheManager {

    private Context mContext;
    private List<MyFeeds.Feed> myFeedsList;

    public HomeViewFeedAdapter_working_backup(Context mContext, List<MyFeeds.Feed> myFeedsList) {
